...
```{r, echo = FALSE, message = FALSE, warning=FALSE, fig.cap= "Percentage of games with late-game fouls by leading teams across the past 21 seasons", fig.align='center'}
...
```{r, echo = FALSE, message = FALSE, warning=FALSE, fig.cap= "The frequency of the leading teams’ fouls by seconds left on the clock", fig.align='center'}
...
```{r, echo = FALSE, message = FALSE, warning=FALSE, fig.cap= "Success rates of leading teams with fouling versus no fouling late in the game", fig.align='center'}
...
```{r, echo = FALSE, message = FALSE, warning=FALSE, fig.cap= "Interaction between whether the leading team fouls and the opponent’s free-throw percentage", fig.align='center'}
...
## Scraping the data into `nba_foul_data`
...
# `foul` mean = % of fouls in the data set = 0.05637
# `success` mean = % of games where the leading teams won = 0.9326
summary(nba_foul_data[c("foul", "success")])
...
ggplot(fouls_by_season, aes(x = factor(season), y = foul_percent)) +
  geom_line(group = 1, color = "darkorange2", linewidth = 0.8) + 
  geom_point(color = "darkorange2", size = 1.5) +  
  labs(title="Percentage of Games with Late-Game Fouls by Season",
       x="Season",
       y="Percentage") +
  theme_minimal(base_size = 12)
...
ggplot(success_rates, aes(x = foul, y = SuccessRate, fill = foul)) +
  geom_bar(stat = "identity", width = 0.45) +
  scale_fill_manual(values = c("darkorange2", "peachpuff")) +
  labs(title = "Success Rate by Late-Game Foul Strategy",
       x = "Strategy",
       y = "Success Rate",
       fill = "Strategy") +
  theme_minimal(base_size = 12) +
...
# Display distribution of when the fouls took place ---------------------
ggplot(nba_foul_data, aes(x = clock_seconds)) +
  geom_histogram(bins = 35, fill = "darkorange2", color = "white", alpha = 0.8) + 
  labs(title = "When Did Fouls Take Place",
       x = "Seconds on Clock",
       y = "Frequency of Fouls") +
  theme_minimal(base_size = 12) +
  scale_x_reverse()
